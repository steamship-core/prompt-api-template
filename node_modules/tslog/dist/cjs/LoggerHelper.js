...
class LoggerHelper {
    static cleanUpFilePath(fileName) {
        return Object.entries(fileName.split(path_1.sep))
    ...
    static getCallSites(error, cleanUp = true) {
        const stack = error == null ? (0, CallSitesHelper_1.getCallSites)(new Error()).slice(1) : (0, CallSitesHelper_1.getCallSites)(error);
    ...
    */
    static _getCodeFrame(filePath, lineNumber, columnNumber, linesBeforeAndAfter) {
        ...
        try {
            const file = (_a = (0, fs_1.readFileSync)(filePath, {
                encoding: "utf-8",
